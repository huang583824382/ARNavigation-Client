...
{
    [HideInInspector] public enum NotificationType { Success, Info, Warning, Error }
    ...
    [SerializeField] private float m_DurationBeforeFadeOut = 1f;
    [SerializeField] private float m_FadeOutDuration = 0.5f;
    [SerializeField] private Sprite m_SuccessIcon = null;
    [SerializeField] private Sprite m_InfoIcon = null;
    [SerializeField] private Sprite m_WarningIcon = null;
    [SerializeField] private Sprite m_ErrorIcon = null;
    ...
    public void SetIconAndText(NotificationType notificationType, string text, float duration)
    {
        ClearLastNotification();
        m_TextMeshProUGUI.text = text;
        m_DurationBeforeFadeOut = duration;
